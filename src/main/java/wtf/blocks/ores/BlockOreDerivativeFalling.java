...
public class BlockOreDerivativeFalling extends AbstractBlockDerivativeFalling implements IOre {

    public BlockOreDerivativeFalling(IBlockState backState, IBlockState foreState) {
