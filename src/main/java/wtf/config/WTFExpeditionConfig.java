...
public class WTFExpeditionConfig {
	...
	public static boolean onlyDerivativeOresFracture;
	public static boolean preventOrePlacement;
	...
	public static boolean replaceOreWithEquivalents;
	...
	public static void syncConfig() {
		...
		property = config.get(category, "Ores fracture adjacent stone upon mining. Individual ores can be removed from their ore entries", true);
		miningOreFractures = property.getBoolean();
		propertyOrder.add(property.getName());

		property = config.get(category, "Only ores generated by Expedition fracture adjacent blocks when mined", true);
		onlyDerivativeOresFracture = property.getBoolean();
		propertyOrder.add(property.getName());

		property = config.get(category, "Prevent placement of ores if they fracture adjacent blocks when mined", true);
		preventOrePlacement = property.getBoolean();
		propertyOrder.add(property.getName());
		...
		property = config.get(category, "Attempt to replace loose ores (such as coal ore in fossils) with Expedition equivalents", true);
		replaceOreWithEquivalents = property.getBoolean();
		propertyOrder.add(property.getName());

		property = config.get(category, "Expedition ores drop stone when harvested", true);
