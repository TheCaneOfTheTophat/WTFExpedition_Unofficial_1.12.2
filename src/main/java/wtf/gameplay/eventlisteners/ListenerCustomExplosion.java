...
public class ListenerCustomExplosion {
	...
	public void explosion(ExplosionEvent.Start event) {
		...
		float size = ObfuscationReflectionHelper.getPrivateValue(Explosion.class, explosion, "field_77280_f");
		boolean fire = ObfuscationReflectionHelper.getPrivateValue(Explosion.class, explosion, "field_77286_a");
